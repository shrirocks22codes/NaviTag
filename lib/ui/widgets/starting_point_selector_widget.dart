...
/// A mobile-optimized starting point selection widget with search and filtering capabilities
class StartingPointSelectorWidget extends ConsumerStatefulWidget {
  /// Callback when a starting point is selected
  ...
  const StartingPointSelectorWidget({
    super.key,
  ...
  @override
  ConsumerState<StartingPointSelectorWidget> createState() => _StartingPointSelectorWidgetState();
}

class _StartingPointSelectorWidgetState extends ConsumerState<StartingPointSelectorWidget> {
  ...
  void _handleLocationSelection(Location location) {
    ...
    widget.onStartingPointSelected?.call(location);
    
    // Set as current location in navigation controller
    ref.read(navigationControllerProvider.notifier).setCurrentLocation(location.id);
    
    // Show confirmation
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Starting point set to ${location.name}'),
